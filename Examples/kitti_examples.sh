...
./Monocular/mono_kitti ../Vocabulary/ORBvoc.txt ./Monocular/KITTI03.yaml "$pathDatasetEuroc"/data_odometry_gray/dataset/sequences/03 "$pathDatasetEuroc"/data_odometry_gray/dataset/segments/03
